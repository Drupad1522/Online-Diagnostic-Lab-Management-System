					...
					<h3>welcome to the laboratory !</h3>
					    <div class="about-grids">
							<div class="col-md-4 about-grid">
								...
								<p>Get accurate and timely reports from our Certified partenr Laboratories</p>
							</div>
							<div class="col-md-4 about-grid">
								<img src="images/p2.jpg"  class="img-responsive" alt="">
								<h4>Affordabkle Pricing</h4>
								<p>Get the best price for test and packges by comparing across multiple labs.</p>
							</div>
							<div class="col-md-4 about-grid">
								<img src="images/p3.jpg"  class="img-responsive" alt="">
								<h4>Convenice</h4>
								<p>Get your reports collected at the comfort of your home </p>
							</div>
								<div class="clearfix"></div>
						</div>
					</div>
...
<!--//gallery-->
	...
	<div class="footer-section">
						...
						<p>Online Diagnostic Lab Management System for DBMS Mini project@MITT</p>
									</div>
							<script type="text/javascript">
